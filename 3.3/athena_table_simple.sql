CREATE EXTERNAL TABLE IF NOT EXISTS blocket_cars (
  ...
  data_advertiser_account_id STRING,
  data_advertiser_contact_methods_mc STRING,
  ...
  data_advertiser_public_profile_blocket_account_id STRING,
  data_advertiser_public_profile_display_name STRING,
  data_advertiser_public_profile_number_of_active_ads STRING,
  data_advertiser_public_profile_reviews_overall_score STRING,
  data_advertiser_public_profile_reviews_reviews_received_count STRING,
  data_advertiser_public_profile_verified STRING,
  ...
  data_blocket_package_ad_id STRING,
  ...
  data_blocket_package_feature_swish STRING,
  data_blocket_package_features_is_part_of_merge STRING,
  data_blocket_package_is_in_dispute STRING,
  ...
  data_price_old_value STRING,
  data_price_price_lowered STRING,
  data_price_suffix STRING,
  data_price_value STRING,
  data_saved STRING,
  data_saved_count STRING,
  data_share_url STRING,
  data_state_id STRING,
  data_subject STRING,
  data_type STRING,
  data_zipcode STRING,
  ...
  inventory_context_gam_network_id STRING,
